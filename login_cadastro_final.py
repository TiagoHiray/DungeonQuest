...
def principal():
    ...
    #LOGIN
    img1=ImageTk.PhotoImage(Image.open("dungeon_quest-main/game/assets/sprites/backgrounds/fundo.png"))
    global l1
    ...
    img2=ImageTk.PhotoImage(Image.open("dungeon_quest-main/game/assets/sprites/backgrounds/fundo2.jpg"))
